...
def josephus(n):
    """ The problem described is the same as he josephus problem

    This can be solved by rotating the MSB to the LSB side in binary 
    representation. See https://www.youtube.com/watch?v=uCsD3ZGzMgE
    """
    return int("{0:b}".format((n << 1) + 1)[1:], 2)

if __name__ == '__main__':
    assert josephus(41) == 19
    assert josephus(5) == 3
